...
if __name__ == "__main__":
    split_frac = 0.85
    train_data = datasets.CIFAR100(root='/data/input-ai/datasets/cifar_10_ssl/cifar100_raw', train=True, download=True)
    test_data = datasets.CIFAR100(root='/data/input-ai/datasets/cifar_10_ssl/cifar100_raw', train=False, download=True)
    ...
    dump_data('/data/input-ai/datasets/cifar_10_ssl/cifar100_raw', train_data, train_members, test_data, test_members)
