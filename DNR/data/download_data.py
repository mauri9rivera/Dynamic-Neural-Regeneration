...
if __name__ == '__main__':
    train_data = Cub2011('/data/input-ai/datasets/cifar_10_ssl/', train=True, download=False)
    test_data = Cub2011('/data/input-ai/datasets/cifar_10_ssl/', train=False, download=False)
