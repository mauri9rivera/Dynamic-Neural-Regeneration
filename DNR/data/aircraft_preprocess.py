...
if __name__ == '__main__':
    train_data = Aircraft('/data/input-ai/datasets/cifar_10_ssl/', train=True, download=True)
    test_data = Aircraft('/data/input-ai/datasets/cifar_10_ssl/', train=False, download=True)
